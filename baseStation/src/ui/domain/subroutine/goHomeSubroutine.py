...
class GoHomeSubroutine(Subroutine):
    ...
    def _button_click(self) -> None:
        try:
            self._subroutine_runner.execute_go_home_subroutine(CommandCallback(self._button_click_done))
